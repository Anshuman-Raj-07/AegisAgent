...
describe('Token Bucket Rate Limiter Throttling', (assert) => {
  ...
  {
    id: 'custom-spec',
    name: 'Custom Target Spec',
    shortDesc: 'Write your own requirements spec and let the agents build it dynamically in Live Mode.',
    spec: `# Specification: Custom Target Spec

Write your requirements here (e.g., "Implement a Binary Search Tree with insert and search methods").

NOTE: To execute this custom scenario, you must add your Google Gemini API Key in the settings dialog (⚙ top-right) and run a live workflow.`,
    files: {
      'src/index.js': `// Implementation will be generated by the Developer Agent...`,
      'tests/index.test.js': `// Test cases will be generated by the Tester Agent...`
    },
    logs: [
      {
        stage: 'architect',
        timestamp: '12:00:00 PM',
        message: 'Awaiting dynamic custom generation...',
        details: 'Please add your Google Gemini API Key in settings (⚙ top-right) to trigger live generation.'
      }
    ],
    checklist: [
      {
        id: 'chk-custom-1',
        rule: 'Unit Test Assertions Passed',
        description: 'Verifies all unit assertions generated by the Tester Agent run and pass successfully.',
        checkType: 'test'
      }
    ],
    qa: [
      {
        id: 'custom-q1',
        category: 'First-Principles Design',
        question: 'How do you defend the design of this custom algorithm?',
        answer: 'Since this is a custom specification, please enter your Gemini API Key and run a live workflow to unlock direct architectural challenges on the generated code.'
      }
    ]
  }
];
